...
The bias-variance decomposition panel is the most complicated. We have to calculate the expected value of the target value for $\mathbf{x} = (0, \ldots, 0)$ predicted by 1-nearest-neighbor given a sample of $n = 1000$ observations. We estimate the expected value by drawing 10000 samples with 1000 observations, calculating the target value of the nearest neighbor to zero and the empirical mean of these predictions.
